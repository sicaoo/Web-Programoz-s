    ...
    <div id="site_content">
        ...
        <div id="content">
            ...
            <div class="container">
                ...
                FROM product
                WHERE product_name='Smaragd tuja (Thuja occidentalis)';";
                        $result = $conn->query($sql);
                        $row = $result->fetch_assoc();
                        echo '<img src="data:image/jpeg;base64,'.base64_encode( $row['image'] ).'" class="d-block w-100" alt="Kép megjelenítési probléma" style="margin-top:5%; height:350px" />';
