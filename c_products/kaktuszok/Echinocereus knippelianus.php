    ...
    <div id="site_content">
        ...
        <div id="content">
            ...
            <div class="container">
                ...
                FROM product
                WHERE product_name='Echinocereus knippelianus';";
                        $result = $conn->query($sql);
                        $row = $result->fetch_assoc();
                        echo '<img src="data:image/jpeg;base64,'.base64_encode( $row['image'] ).'" class="d-block w-100" alt="Kép megjelenítési probléma" style="margin-top:10%; height:450px" />';
                    ...
                    <div class="back_products">
                        <button type="button" class="btn btn-success"><a href="/eden2/costumer/kaktuszok.php">Vissza</a></button>
                    </div>
                </div>
            </div>
        </div>
