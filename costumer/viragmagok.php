...
";
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                ...
                echo '<img src="data:image/jpeg;base64,'.base64_encode( $row['image'] ).'" height="400px" alt="kép megjelenítési probléma"/>';
                echo "</div>";?>
            <form method="post" action="order.php?action=add&id=<?php echo $row["product_id"]; ?>">
               <?php
                ...
                $php_dot='.php';
                echo"<button type=text><a href='/eden2/c_products/viragmagok/".$name.$php_dot."'>Tovább</a></button>";
                echo"<br>";
