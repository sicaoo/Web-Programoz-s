    ...
    <div id="site_content">
        ...
        <div id="content">
            ...
            if(isset($_POST['search']))
            {
               ...
               $sql="SELECT * FROM product WHERE product_name like'%$search%' or product_type LIKE '%$search%';";
               ...
               if ($result->num_rows> 0)
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        $php_dot='.php';
                        echo"<button type=text><a href='/eden2/c_products/".$type."/".$name.$php_dot."'>Tovább</a></button>";
                        echo"</div>";
                        echo"</div>";
