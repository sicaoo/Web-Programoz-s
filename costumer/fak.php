    ...
    <div id="site_content">
        ...
        <div id="content">
            ...
            $sql = "SELECT product_id,product_name,product_type, description, stock,price, image,cheaper,new 
                FROM product
                WHERE product_type='Gyümölcsfa' or product_type='Tuja' or product_type= 'Fenyő';";
            ...
            <form method="post" action="order.php?action=add&id=<?php echo $row["product_id"]; ?>">
                <?php
                    ...
                    $php_dot='.php';
                    echo"<button type=text><a href='/eden2/c_products/fak/".$name.$php_dot."'>Tovább</a></button>";
                    echo"<br>";
