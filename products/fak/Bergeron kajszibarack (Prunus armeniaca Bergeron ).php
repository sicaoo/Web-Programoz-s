            ...
            <div class="container">
                ...
                WHERE product_name='Bergeron kajszibarack (Prunus armeniaca Bergeron )';";
                    ...
                    <div class="back_products">
                        <button type="button" class="btn btn-success"><a href="/eden2/fak.php">Vissza</a></button>
                    </div>
                </div>
            </div>
        </div>
        <div id="footer">
            <p><a href="/eden2/index.php">Kezdőoldal</a> | <a href="/eden2/akciok.php">Akciók</| <a href="order.php">Megrendelés</a> | <a href="contact.php">Kontakt</a></p>
